...
function buildDoc(q) {
  ...
  // 统一保留图片列，无图片时显示「—」占位
  const productCols = [
    { text: '图片', style: 'th', width: 63, alignment: 'center' },
    { text: '产品名称', style: 'th', width: 104 },
    { text: '品牌', style: 'th', width: 63 },
    { text: '型号', style: 'th', width: 63 },
    { text: '颜色', style: 'th', width: 63 },
    { text: '参数描述', style: 'th', width: 114 },
