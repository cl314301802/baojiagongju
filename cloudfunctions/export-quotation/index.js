...
function buildDoc(q) {
  ...
  // 统一保留图片列，无图片时显示「—」占位
  const productCols = [
    { text: '图片', style: 'th', width: 70, alignment: 'center' },
    { text: '产品名称', style: 'th', width: 106 },
    { text: '品牌', style: 'th', width: 76 },
    { text: '型号', style: 'th', width: 76 },
    ...
    { text: '小计', style: 'th', width: 110, alignment: 'right' }
  ]
